...
if(isset($_POST['submit'])){
    ...
    $industry_id = filter_input(INPUT_POST,'industry_id',FILTER_SANITIZE_SPECIAL_CHARS); // Changed from industry to industry_id
    ...
    if(in_array($file_ext,$allowed_ext)){
     if($file_size<=1000000){
        ...
        // FIXED: Added WHERE clause to update only the current student
        $sql = "UPDATE students SET 
                ...
                WHERE uid = '$user_id'"; // THIS IS THE CRITICAL FIX
...
<body style="background-color: #6f2449d1; text-align:center;color: white;">
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="rounded-circle mt-5" width="150px" src="<?php echo $user_imgsrc?>">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-12"><label class="labels">Email Address</label><input type="email" name="email" class="form-control" placeholder="enter email address" value="<?php echo $user_email?>" required></div>
                    <div class="col-md-12"><label class="labels">Name of industry</label>
                        <select name="industry_id" class="form-control" required>
                            <?php
                            $res = mysqli_query($conn, "SELECT * FROM itsupervisor ORDER BY name");
                            while($r = mysqli_fetch_assoc($res)){
                                $selected = ($r['id'] == $user_userindustry) ? 'selected' : '';
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-6"><label class="labels">Registration no</label><input type="text" name="studid" class="form-control" value="<?php echo $user_stuid?>" placeholder="Registration number" required></div>
                </div>
