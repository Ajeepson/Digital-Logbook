...
$stud_id = $user_details['uid']; // THIS is the right one
...
<section>
<div class="container">
<div style="background-color: #6f2449d1; text-align:center;color: white;">
  ...
  <?php if(empty($output1)): ?>
        ...
        <?php endif;?>
    <a class="btn btn-primary btn-lg" style="background-color:#b582a7" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal2"  role="button">Progress Chart</a>
  </p>
</div>
</div>
</section>
    ...
    <div class="modal-content">
      ...
      <form action="postprogress.php" method="post" enctype="multipart/form-data" >
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-8">
  <input type="hidden" name="stuid" value="<?php echo $stud_id; ?>">
</div>
